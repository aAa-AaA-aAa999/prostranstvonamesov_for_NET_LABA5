...
namespace ReaderNS //Создать другое пространство имен с классом Reader,
...
class Program
{
    static void Main(string[] args) //В методе main создать два массива объектов, содержащих по три элемента каждый
    {
        ...
        Reader[] readers = new Reader[3]
                {
                new Reader("Гусин А. Д.", "123456", "Английского языка", "1998.02.12", "+71234567890"),
                new Reader("Кислый Е. Д.", "234567", "Английского языка", "1999.12.02", "+71234567891"),
                new Reader("Модный Н. Н.", "345078", "Английского языка", "2002.01.9", "+71234567892")
                };
